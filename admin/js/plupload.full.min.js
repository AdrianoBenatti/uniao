...
!function (e, t) {
	...
	function n(e, t) {
		for (var n, i = [], r = 0; r < e.length; ++r) {
			if (n = s[e[r]] || o(e[r]), !n)throw"módulo de definição de dependência não encontrado: " + e[r];
			i.push(n)
		}
		t.apply(null, i)
	}
	...
	function i(e, i, r) {
		if ("string" != typeof e)throw"módulo de definição inválido, módulo id precisa ser definido e ser caracteres";
		if (i === t)throw"módulo de definição inválido, dependências precisam ser especificadas";
		if (r === t)throw"módulo de definição inválido, funções precisam ser especificadas";
		n(i, function () {
	...
	i(u, [], function () {
				...
				connectRuntime: function (r) {
					function o(n) {
						...
						return n.length ? (s = n.shift().toLowerCase(), (u = i.getConstructor(s)) ? (e = new u(r), e.bind("Init", function () {
							...
							e.destroy(), o(n)
						}), e.mode ? void e.init() : void e.trigger("")) : void o(n)) : (a.trigger("", new t.RuntimeError(t.RuntimeError.NOT_INIT_ERR)), void(e = null))
					}
		...
		return e.extend(t.prototype, {
			littleEndian: !1, read: function (e, t) {
				var n, i, r;
				if (e + t > this.length())throw new Error("Não foi possível ler o arquivo além dos limites de origem. Tente novamente.");
				for (i = this.littleEndian ? 0 : -8 * (t - 1), r = 0, n = 0; t > r; r++)n |= this.readByteAt(e + r) << Math.abs(i + 8 * r);
				return n
			}, write: function (e, t, n) {
				var i, r, o = "";
				if (e > this.length())throw new Error("Não foi possível escrever o arquivo além dos limites de origem. Tente novamente.");
		...
		function r(o) {
			...
			if (n.call(this, o), c = {
					...
					Flash: {
						0: "Flash não disparou",
						1: "Flash disparado",
						5: "Luz de retorno do estroboscópio não detectada",
						7: "Luz de retorno do estroboscópio detectada",
						9: "Flash disparado, modo de flash obrigatório",
						13: "Flash disparado, modo de flash compulsório, luz de retorno não detectada",
						15: "Flash disparado, modo de flash compulsório, luz de retorno detectada",
						16: "Flash did not fire, compulsory flash mode",
						24: "Flash did not fire, auto mode",
						25: "Flash disparado, auto mode",
						29: "Flash disparado, auto mode, return light not detected",
						31: "Flash disparado, auto mode, return light detected",
						32: "Sem função de flash",
						65: "Flash disparado, Modo de redução de olhos vermelhos",
						69: "Flash disparado, Modo de redução de olhos vermelhos, luz de retorno não detectada",
						71: "Flash disparado, Modo de redução de olhos vermelhos, luz de retorno detectada",
						73: "Flash disparado, modo de flash compulsório, Modo de redução de olhos vermelhos",
						77: "Flash disparado, modo de flash compulsório, Modo de redução de olhos vermelhos, luz de retorno não detectada",
						79: "Flash disparado, modo de flash compulsório, Modo de redução de olhos vermelhos, luz de retorno detectada",
						89: "Flash disparado, modo automático, Modo de redução de olhos vermelhos",
						93: "Flash disparado, modo automático, luz de retorno não detectada, Modo de redução de olhos vermelhos",
						95: "Flash disparado, modo automático, luz de retorno detectada, Modo de redução de olhos vermelhos"
					},
...
(function (e, t, n) {
	...
	o.addFileFilter("mime_types", function (e, t, n) {
		e.length && !e.regexp.test(t.name) ? (this.trigger("Error", {
			code: "",
			message: o.translate("Extensão do arquivo inválida."),
			file: t
		}), n(!1)) : n(!0)
		...
		e = o.parseSize(e), t.size !== r && e && t.size > e ? (this.trigger("Error", {
			code: "",
			message: o.translate("Tamanho do arquivo excede o limite. Tente outro arquivo."),
			file: t
		}), n(!1)) : n(!0)
		...
		if (e) {
			...
			while (r--)if (t.name === this.files[r].name && t.size === this.files[r].size) {
				this.trigger("Error", {
					code: "",
					message: o.translate("Arquivo duplicado. Tente outro arquivo."),
					file: t
				}), n(!1);
				return
			}
		...
		function N(e, n, r) {
			...
			typeof e == "object" ? o.each(e, function (e, t) {
				...
				e ? (i.runtime = t.Runtime.getInfo(w()).type, i.trigger("Init", {runtime: i.runtime}), i.trigger("PostInit")) : i.trigger("Error", {
					code: o.INIT_ERROR,
					message: o.translate("Não foi possível iniciar o processo. Tente novamente.")
				})
			}))
		}
		...
		function k(e, n) {
			function h() {
				u-- > 0 ? r(p, 1e3) : (n.loaded = f, e.trigger("Error", {
					code: o.HTTP_ERROR,
					message: o.translate("Ocorreu uma oscilação na conexão e ela foi interrompida. Tente novamente."),
					file: n,
			...
			init: function () {
				...
				r = e.getOption("preinit"), typeof r == "function" ? r(e) : o.each(r, function (t, n) {
					...
					if (e.getOption(t) === null)return i = {
						code: o.INIT_ERROR,
						message: o.translate("'%' especificado, mas não encontrado.")
					}, !1
				});
				if (i)return e.trigger("Error", i);
				if (!a.browse_button && !a.drop_element)return e.trigger("Error", {
					code: o.INIT_ERROR,
					message: o.translate("Você deve escolher entre 'browse_button' ou 'drop_element'.")
				});
