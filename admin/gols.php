<?php autorizar("gols"); ?>
<?php $query = mysql_query("SELECT * FROM gols ORDER BY id ASC", $connect); ?>

<script>
	$(document).ready(function() {
		generateDataTable('gols','id','desc');
	});
</script>
<div id="conteudo">
	<div class="center">
		<div class="header">
			<h1>Gols E.C União Santa Luiza</h1>
			<div class="buttons">
				<input type="button" onclick="location.href='<?php echo $url; ?>golsManutencao/Incluir/0'" class="btn-padrao criar" value="Novo" />
		...
		<?php }else{?>
			<table border="0" cellspacing="1" class="adminlist" id="gols" bordercolor="#FFFFFF" width="100%">
				<thead>
				<tr>
					<td width="5%"></td>
					<th width="5%" align="center">ID</th>
					<th width="90%" align="center">Total de gols</th>
				</tr>
				</thead>
				<tfoot></tfoot>
				<tbody>
				...
				while($dados = mysql_fetch_array($query)){
					...
					$altlink = "{$url}golsManutencao/Alterar/".$id;
					?>
					<tr>
						...
						<td width="90%" align="center" onClick="goTo('<?php echo $altlink ?>');"><?php echo $gols ?></td>
